  ...
  return (
    <div>
      <Menu as="div" className="inline-block text-left">
        <div className="flex">
          ...
          >
            <div className="leading[80px] flex flex-col items-start">
              {/* nếu giá trị của firstname là null hoặc undefined thì lấy giá trị của name */}
        ...
        >
          <Menu.Items
            className="absolute z-50 right-2 mt-2 w-56
            origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg focus:outline-none"
          >
            <div className="p-1 ">
              <Menu.Item>
                {({ active }) => (
        ...
        <nav className="container mx-auto flex items-center justify-between p-5">
          <div>
            <Link to="/" className="text-blue-600 font-bold text-xl">
              Top<span className="text-[#1677cccb]">Job</span>
            </Link>
          </div>
